 ...
 * {@link IntMath} respectively.  For other common operations on
 *
...
public class LongMath {
    ...
    public static int log2(long x, RoundingMode mode) {
        CValidationUtils.isTrue(x > 0);
        switch (mode) {
            case UNNECESSARY:
                CValidationUtils.isTrue(isPowerOfTwo(x));
                // fall through
            case DOWN:
            case FLOOR:
    ...
    public static int log10(long x, RoundingMode mode) {
        ...
        switch (mode) {
            case UNNECESSARY:
                CValidationUtils.isTrue(x == floorPow);
                // fall through
            case FLOOR:
            case DOWN:
                return logFloor;
    ...
    public static long sqrt(long x, RoundingMode mode) {
        ...
        switch (mode) {
            case UNNECESSARY:
                CValidationUtils.isTrue(guessSquared == x);
                return guess;
            case FLOOR:
            case DOWN:
                if (x < guessSquared) {
    ...
    public static long gcd(long a, long b) {
         ...
         * an int.
         */
        CValidationUtils.isTrue(a > 0);
        CValidationUtils.isTrue(b > 0);
        if (a == 0) {
    ...
    public static long checkedAdd(long a, long b) {
        long result = a + b;
        CValidationUtils.isTrue((a ^ b) < 0 | (a ^ result) >= 0);
        return result;
    }
    ...
    public static long checkedMultiply(long a, long b) {
        ...
        CValidationUtils.isTrue(leadingZeros >= Long.SIZE);
        CValidationUtils.isTrue(a >= 0 | b != Long.MIN_VALUE);
        long result = a * b;
        CValidationUtils.isTrue(a == 0 || result / a == b);
        return result;
    }
        ...
        if (b >= -2 & b <= 2) {
            switch ((int) b) {
                ...
                case (-1):
                    return ((k & 1) == 0) ? 1 : -1;
                case 2:
                    CValidationUtils.isTrue(k < Long.SIZE - 1);
                    return 1L << k;
                case (-2):
                    CValidationUtils.isTrue(k < Long.SIZE);
                    return ((k & 1) == 0) ? (1L << k) : (-1L << k);
                default:
                    throw new AssertionError();
            }
        ...
        while (true) {
            switch (k) {
                ...
                default:
                    ...
                    k >>= 1;
                    if (k > 0) {
                        CValidationUtils.isTrue(b <= FLOOR_SQRT_MAX_LONG);
                        b *= b;
                    }
            }
        }
