...
import static com.wildbeeslabs.jentle.algorithms.utils.Lists.newArrayList;
...
public class Throwables {
     ...
     */
    public static void appendStackTraceInCurrentThreadToThrowable(final Throwable t, final String methodToStartFrom) {
    ...
    private static List<StackTraceElement> stackTraceInCurrentThread(final String methodToStartFrom) {
     ...
     */
    public static void removeAssertJRelatedElementsFromStackTrace(final Throwable throwable) {
    ...
    public static Throwable getRootCause(Throwable throwable) {
        if (Objects.isNull(throwable.getCause())) return null;
        Throwable cause;
