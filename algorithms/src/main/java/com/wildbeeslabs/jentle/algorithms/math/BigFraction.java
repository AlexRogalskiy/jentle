...
/**
 * Arbitrary-precision fraction, utilizing java.math.BigIntegers for numerator
...
public final class BigFraction
    ...
    implements Comparable<java.lang.Number> {
    private static final long serialVersionUID = 3L; //because Number is Serializable
    private final java.math.BigInteger mNumerator;
    private final java.math.BigInteger mDenominator;

    //some constants used
    private final static java.math.BigInteger BIGINT_TWO = java.math.BigInteger.valueOf(2);
    private final static java.math.BigInteger BIGINT_FIVE = java.math.BigInteger.valueOf(5);

    /**
     * The value 0/1.
     */
    public final static BigFraction ZERO = new BigFraction(java.math.BigInteger.ZERO, java.math.BigInteger.ONE, Reduced.YES);
    /**
     * The value 1/1.
     */
    public final static BigFraction ONE = new BigFraction(java.math.BigInteger.ONE, java.math.BigInteger.ONE, Reduced.YES);
    /**
     * The value 1/2.
     */
    public final static BigFraction ONE_HALF = new BigFraction(java.math.BigInteger.ONE, BIGINT_TWO, Reduced.YES);
    /**
     * The value 1/10.
     */
    public final static BigFraction ONE_TENTH = new BigFraction(java.math.BigInteger.ONE, java.math.BigInteger.TEN, Reduced.YES);
    /**
     * The value 10/1.
     */
    public final static BigFraction TEN = new BigFraction(java.math.BigInteger.TEN, java.math.BigInteger.ONE, Reduced.YES);
    ...
    /**
     * <strong>Note:</strong> should be preferred for performance reasons.
     * This constructor is provided for convenience.
     *
     * @param n Number to convert to BigFraction.
     */
    public BigFraction(java.lang.Number n) {
     ...
     */
    public BigFraction(java.lang.Number numerator, java.lang.Number denominator) {
     ...
     */
    public BigFraction(java.lang.Number numerator, java.lang.Number denominator, boolean reduce) {
     ...
     */
    public static BigFraction valueOf(java.lang.Number n) {
        if (n == null)
        ...
        if (n instanceof BigFraction)
            ...
            return new BigFraction(toBigInteger(n), java.math.BigInteger.ONE, Reduced.YES);
     ...
     */
    public static BigFraction valueOf(java.lang.Number numerator, java.lang.Number denominator) {
     ...
     * @throws IllegalArgumentException if numerator or denominator is null.
     */
    public static BigFraction valueOf(java.lang.Number numerator, java.lang.Number denominator, boolean reduce) {
        if (numerator == null)
     ...
     * can be parsed by the {@link java.math.BigInteger#{String, int)} constructor. This means
     ...
     */
    public final java.math.BigInteger getNumerator() {
        return mNumerator;
    }
     ...
     */
    public final java.math.BigInteger getDenominator() {
        return mDenominator;
    }
     ...
     * @throws IllegalArgumentException if n is null.
     */
    public BigFraction add(java.lang.Number n) {
        if (isZero(n))
            return this;
     ...
     */
    public static BigFraction sum(java.lang.Number a, java.lang.Number b) {
     ...
     * @throws IllegalArgumentException if n is null.
     */
    public BigFraction subtract(java.lang.Number n) {
        if (isZero(n))
            return this;
     ...
     * @throws IllegalArgumentException if n is null.
     */
    public BigFraction subtractFrom(java.lang.Number n) {
        if (isZero(n))
            return this.negate();
     ...
     * @throws IllegalArgumentException if a or b is null.
     */
    public static BigFraction difference(java.lang.Number a, java.lang.Number b) {
     ...
     * @throws IllegalArgumentException if n is null.
     */
    public BigFraction multiply(java.lang.Number n) {
        if (isZero(n))
     ...
     * @throws IllegalArgumentException if a or b is null.
     */
    public static BigFraction product(java.lang.Number a, java.lang.Number b) {
     ...
     */
    public BigFraction divide(java.lang.Number n) {
        if (isOne(n))
            return this;
     ...
     */
    public BigFraction divideInto(java.lang.Number n) {
        if (isOne(n))
     ...
     */
    public static BigFraction quotient(java.lang.Number a, java.lang.Number b) {
     ...
     */
    public BigFraction gcd(java.lang.Number n) {
        BigFraction f = valueOf(n);
        ...
        java.math.BigInteger num = mNumerator.gcd(f.mNumerator);
        java.math.BigInteger den = mDenominator.multiply(f.mDenominator).abs().divide(mDenominator.gcd(f.mDenominator));
     ...
     */
    public BigFraction lcm(java.lang.Number n) {
        BigFraction f = valueOf(n);
        ...
        //result will not be reduced, and the operation actually takes about 60% longer.
        java.math.BigInteger num = mNumerator.multiply(f.mNumerator).abs().divide(mNumerator.gcd(f.mNumerator));
        java.math.BigInteger den = mDenominator.gcd(f.mDenominator);
     ...
     * {@link java.math.BigInteger#pow(int)}, and {@link BigDecimal#pow(int)}.
     *
     ...
     */
    public java.math.BigInteger round(RoundingMode roundingMode) {
        if (roundingMode == null)
            throw new IllegalArgumentException("Null argument");

        //Since fraction is always in lowest terms, this is an exact integer
        //iff the denominator is 1.
        if (mDenominator.equals(java.math.BigInteger.ONE))
            return mNumerator;
        ...
        java.math.BigInteger intVal = null;
        java.math.BigInteger remainder = null;
        ...
        if (ROUND_HALF_MODES.contains(roundingMode) && !mDenominator.equals(BIGINT_TWO)) {
            java.math.BigInteger[] divMod = mNumerator.divideAndRemainder(mDenominator);
            intVal = divMod[0];
            remainder = divMod[1];
        } else {
        ...
        if (roundingMode == RoundingMode.UP) {
            if (mNumerator.signum() > 0)
                intVal = intVal.add(java.math.BigInteger.ONE);
            else
                intVal = intVal.subtract(java.math.BigInteger.ONE);
        }
     ...
     */
    public BigFraction roundToNumber(java.lang.Number n) {
     ...
     */
    public BigFraction roundToNumber(java.lang.Number n, RoundingMode roundingMode) {
     ...
     * @see #roundToDenominator(java.math.BigInteger, RoundingMode)
     */
    public java.math.BigInteger roundToDenominator(java.math.BigInteger newDenominator) {
     ...
     *                                  given denominator.
     */
    public java.math.BigInteger roundToDenominator(java.math.BigInteger newDenominator, RoundingMode roundingMode) {
        if (newDenominator == null || roundingMode == null)
            throw new IllegalArgumentException("Null argument");

        if (newDenominator.compareTo(java.math.BigInteger.ZERO) <= 0)
            throw new ArithmeticException("newDenominator must be positive");
    ...
    public String toString(int radix, boolean denominatorOptional) {
        if (denominatorOptional && mDenominator.equals(java.math.BigInteger.ONE))
    ...
    public String toRadixedString(int radix, int numFractionalDigits, RoundingMode roundingMode) {
        ...
        if (numFractionalDigits > 0) {
            ...
            java.math.BigInteger rounded = this.multiply(java.math.BigInteger.valueOf(radix).pow(numFractionalDigits)).round(roundingMode);
            ...
            String rounded = this.divide(java.math.BigInteger.valueOf(radix).pow(absFractionalDigits)).round(roundingMode).toString(radix);
    ...
    public String toRepeatingDigitString(int radix, boolean forceRepeating) {
        ...
        java.math.BigInteger absNum = mNumerator.abs();
        ...
        if (mDenominator.equals(java.math.BigInteger.ONE)) {
            if (forceRepeating)
                return sign + absNum.subtract(java.math.BigInteger.ONE).toString(radix) + ".(" + maxDigit + ")";
            else
        ...
        String iPart = "0";
        java.math.BigInteger dividend = absNum;
        if (dividend.compareTo(mDenominator) > 0) {
            java.math.BigInteger[] divmod = absNum.divideAndRemainder(mDenominator);
            iPart = divmod[0].toString(radix);
            dividend = divmod[1];
        }

        java.math.BigInteger bigRadix = java.math.BigInteger.valueOf(radix);
        ...
        Map<java.math.BigInteger, Integer> prevDividends = new HashMap<java.math.BigInteger, Integer>();
        while (!dividend.equals(java.math.BigInteger.ZERO) && !prevDividends.containsKey(dividend)) {
            prevDividends.put(dividend, quotient.length());
            dividend = dividend.multiply(bigRadix); //same as appending a "0" in this base

            java.math.BigInteger[] divmod = dividend.divideAndRemainder(mDenominator);
        ...
        if (dividend.equals(java.math.BigInteger.ZERO)) {
            ...
            String adjustedQuotient = new java.math.BigInteger(quotient.toString(), radix).subtract(java.math.BigInteger.ONE).toString(radix);
     ...
     */
    @Override
    public int compareTo(java.lang.Number n) {
        BigFraction f = valueOf(n);
     ...
     * @throws IllegalArgumentException if n is null
     */
    public java.lang.Number min(java.lang.Number n) {
     ...
     * @throws IllegalArgumentException if n is null
     */
    public java.lang.Number max(java.lang.Number n) {
        return (this.compareTo(n) >= 0 ? this : n);
    }
     ...
     * @throws IllegalArgumentException if n is null
     */
    public BigFraction mediant(java.lang.Number n) {
        BigFraction f = valueOf(n);
     ...
     * @throws IllegalArgumentException if a or b is null
     */
    public static BigFraction mediant(java.lang.Number a, java.lang.Number b) {
    ...
    public BigDecimal toBigDecimal() {
        ...
        java.math.BigInteger tmpDen = mDenominator.shiftRight(twos); // x / 2^n === x >> n

        int fives = 0;
        java.math.BigInteger[] divMod = null;

        //while(tmpDen % 5 == 0) { tmpDen /= 5; fives++; }
        while (java.math.BigInteger.ZERO.equals((divMod = tmpDen.divideAndRemainder(BIGINT_FIVE))[1])) {
            tmpDen = divMod[0];
            fives++;
        }

        if (tmpDen.equals(java.math.BigInteger.ONE)) {
            ...
            java.math.BigInteger unscaled = mNumerator;
    ...
    public long longValue() {
        java.math.BigInteger rounded = this.round(RoundingMode.DOWN);
    ...
    public long longValueExact() {
        if (!mDenominator.equals(java.math.BigInteger.ONE) || mNumerator.bitLength() > 63)
    ...
    public int intValueExact() {
        if (!mDenominator.equals(java.math.BigInteger.ONE) || mNumerator.bitLength() > 31)
    ...
    public byte byteValueExact() {
        if (!mDenominator.equals(java.math.BigInteger.ONE) || mNumerator.bitLength() > 7)
    ...
    private static BigFraction valueOfHelper(BigDecimal d) {
        ...
        java.math.BigInteger tmpNumerator = d.unscaledValue();
        java.math.BigInteger tmpDenominator = java.math.BigInteger.ONE;
        ...
        if (tmpNumerator.equals(java.math.BigInteger.ZERO))
            return BigFraction.ZERO;

        if (d.scale() < 0) {
            tmpNumerator = tmpNumerator.multiply(java.math.BigInteger.TEN.pow(-d.scale()));
        } else if (d.scale() > 0) {
            ...
            while (commonFives < d.scale() && java.math.BigInteger.ZERO.equals((divMod = tmpNumerator.divideAndRemainder(BIGINT_FIVE))[1])) {
    ...
    private static BigFraction valueOfHelper(BigDecimal numerator, BigDecimal denominator) {
        ...
        if (denominator.unscaledValue().equals(java.math.BigInteger.ZERO))
            throw new ArithmeticException("Divide by zero: fraction denominator is zero.");

        //Format of BigDecimal: unscaled / 10^scale
        java.math.BigInteger tmpNumerator = numerator.unscaledValue();
        java.math.BigInteger tmpDenominator = denominator.unscaledValue();
        ...
        if (numerator.scale() > denominator.scale())
            tmpDenominator = tmpDenominator.multiply(java.math.BigInteger.TEN.pow(numerator.scale() - denominator.scale()));
        else if (numerator.scale() < denominator.scale())
            tmpNumerator = tmpNumerator.multiply(java.math.BigInteger.TEN.pow(denominator.scale() - numerator.scale()));
        //else: scales are equal, do nothing.

        java.math.BigInteger gcd = tmpNumerator.gcd(tmpDenominator);
     ...
     */
    private BigFraction(java.math.BigInteger numerator,
     ...
     */
    public static BigFraction reduce(java.math.BigInteger numerator, java.math.BigInteger denominator) {
    ...
    /**
     * Converts a Number to a java.math.BigInteger. Assumes that a check on the
     * type of n has already been performed.
     */
    private static java.math.BigInteger toBigInteger(java.lang.Number n) {
        ...
        if (n instanceof BigDecimal) {
            ...
            return bd.unscaledValue().multiply(java.math.BigInteger.TEN.pow(-bd.scale()));
        }
    ...
    /**
     * Returns true if the given type can be converted to a java.math.BigInteger without loss
     * of precision. Returns true for the primitive integer types (Long, Integer, Short,
     * Byte, AtomicInteger, AtomicLong, LongAdder, LongAccumulator, or java.math.BigInteger).<br>
     * <br>
     ...
     * <br>
     * Used to determine if a Number is appropriate to be passed into tojava.math.BigInteger() method.
     */
    private static boolean isInt(java.lang.Number n) {
        if (n instanceof Long || n instanceof Integer || n instanceof Short || n instanceof Byte || n instanceof java.math.BigInteger || n instanceof AtomicInteger || n instanceof AtomicLong || n instanceof LongAdder || n instanceof LongAccumulator)
            return true;

        if (n instanceof BigFraction)
            return ((BigFraction) n).getDenominator().equals(java.math.BigInteger.ONE);
     ...
     */
    private final static boolean isZero(java.lang.Number n) {
        //micro-optimization- most common type first...
        if (n instanceof BigFraction)
            return ((BigFraction) n).getNumerator().equals(java.math.BigInteger.ZERO);

        if (n instanceof java.math.BigInteger)
            return ((java.math.BigInteger) n).equals(java.math.BigInteger.ZERO);
        ...
        if (n instanceof BigDecimal)
            return ((BigDecimal) n).unscaledValue().equals(java.math.BigInteger.ZERO);
    ...
    private final static boolean isZero(BigFraction f) {
        return f.mNumerator.equals(java.math.BigInteger.ZERO);
    }

    /**
     * Returns true if the given Number represents one. For unknown numbers, utilizes Number.doubleValue().
     */
    private final static boolean isOne(java.lang.Number n) {
        //micro-optimization- most common type first...
        if (n instanceof BigFraction)
        ...
        if (n instanceof java.math.BigInteger)
            return ((java.math.BigInteger) n).equals(java.math.BigInteger.ONE);
