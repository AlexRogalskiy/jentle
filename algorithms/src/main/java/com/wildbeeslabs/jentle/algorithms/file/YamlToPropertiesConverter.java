...
public class YamlToPropertiesConverter {
     ...
     * @throws IllegalArgumentException when the yaml file uses a very high-number of hierarchies, thus causing the
     *                                  maximum depth of the stack to be reached. Augmenting the allocated memory may
     *                                  help (see {@code -Xss} JVM argument.
     */
    static Properties convertToProperties(final InputStream inputStream) throws IllegalArgumentException {
        ...
        if (object != null && object instanceof Map) {
            try {
                ...
                throw new IllegalArgumentException("The Yaml file has too many hierarchies", e);
            }
        }
        return properties;
    }
