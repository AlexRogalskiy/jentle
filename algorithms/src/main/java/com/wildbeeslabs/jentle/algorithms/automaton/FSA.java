...
import com.wildbeeslabs.jentle.algorithms.enums.FSAFlags;
...
public abstract class FSA implements Iterable<ByteBuffer> {
     ...
     *
     * @param stream The input stream to read automaton data from. The stream is not
     *               closed.
     * @return Returns an instantiated automaton. Never null.
     * @throws IOException If the input stream does not represent an automaton or is
     *                     otherwise invalid.
     */
