...
import static com.wildbeeslabs.jentle.algorithms.sort.MergesAndRuns.*;
...
//
        int k;
        k = nodePowerBitwise(1, 100, 10, 20, 25);
        System.out.println(k);
        k = nodePowerLoop(1, 100, 10, 20, 25);
        System.out.println(k);
        k = nodePower(1, 100, 10, 20, 25);
        System.out.println(k);
        System.out.println();

        k = nodePowerBitwise(0, 21, 8, 12, 13);
        System.out.println(k);
        k = nodePowerLoop(0, 21, 8, 12, 13);
        System.out.println(k);
        k = nodePower(0, 21, 8, 12, 13);
        System.out.println(k);
        System.out.println();

        k = nodePowerBitwise(0, 21, 19, 20, 20);
        System.out.println(k);
        k = nodePowerLoop(0, 21, 19, 20, 20);
        System.out.println(k);
        k = nodePower(0, 21, 19, 20, 20);
        System.out.println(k);
        System.out.println();

        k = nodePowerBitwise(0, 100 * 1000 * 1000, 55555555, 55555666, 55556666);
        System.out.println(k);
        k = nodePowerLoop(0, 100 * 1000 * 1000, 55555555, 55555666, 55556666);
        System.out.println(k);
        k = nodePower(0, 100 * 1000 * 1000, 55555555, 55555666, 55556666);
        System.out.println(k);
        System.out.println();
