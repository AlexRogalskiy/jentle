package com.wildbeeslabs.jentle.algorithms.logistics.data;
...
public class SampleDataGenerator implements ServletContextListener {
    ...
    private static void loadHandlingEventData(final JdbcTemplate jdbcTemplate) {
    ...
    private static void loadCargoData(final JdbcTemplate jdbcTemplate) {
        String cargoSql =
    ...
    private static void loadLocationData(final JdbcTemplate jdbcTemplate) {
        String locationSql =
    ...
    private static void loadItineraryData(final JdbcTemplate jdbcTemplate) {
        String legSql =
