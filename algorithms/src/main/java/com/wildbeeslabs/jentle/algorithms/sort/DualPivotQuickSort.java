 ...
 * @author bourgesl
 */
public final class DualPivotQuickSort implements Sorter {
    ...
    private final int[] run = new int[MAX_RUN_COUNT + 1];
 ...
 /*
    ...
    static void sort(int[] a, final int left, int right,
                     int[] work, int workBase, final int workLen,
                     final int[] run) {
