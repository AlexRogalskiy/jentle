...
public class CClassUtils {
    ...
    /**
     * Register the given common classes with the CClassUtils cache.
     */
     ...
     * ClassLoader, if available; the ClassLoader that loaded the CClassUtils
    ...
    public static ClassLoader getDefaultClassLoader() {
        ...
        if (cl == null) {
            ...
            cl = CClassUtils.class.getClassLoader();
            if (cl == null) {
     ...
     * although is usually even more convenient.
     *
     ...
     * <p><b>NOTE:</b>. This method does <i>not</i> resolve Java 5 bridge methods automatically.
     * Call if bridge method resolution is desirable (e.g. for obtaining metadata from
