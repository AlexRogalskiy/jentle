 ...
 */
@UtilityClass
public class ClusterSlotHashUtil {
     ...
     * @since 2.0
     */
    public static boolean isSameSlotForAllKeys(final Collection<ByteBuffer> keys) {
        CValidationUtils.notNull(keys, "Keys must not be null!");
     ...
     * @since 2.0
     */
    public static boolean isSameSlotForAllKeys(final ByteBuffer... keys) {
        CValidationUtils.notNull(keys, "Keys must not be null!");
     ...
     * @return
     */
    public static boolean isSameSlotForAllKeys(final byte[]... keys) {
        CValidationUtils.notNull(keys, "Keys must not be null!");
     ...
     * @return
     */
    public static int calculateSlot(final String key) {
        CValidationUtils.notEmpty(key, "Key must not be null or empty!");
     ...
     * @return
     */
    public static int calculateSlot(final byte[] key) {
        CValidationUtils.notNull(key, "Key must not be null!");
    ...
    private static int indexOf(final byte[] haystack, final int start, final byte needle) {
