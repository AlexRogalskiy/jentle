...
import com.wildbeeslabs.jentle.algorithms.sql.utils.DbUtils;
...
public class QueryRunner {
     ...
     * @param params An ArrayUtils of query replacement parameters.  Each row in
     *               this ArrayUtils is one set of batch replacement values.
    ...
    protected void fillStatement(PreparedStatement stmt, Object[] params, int[] paramTypes)
        ...
        for (int i = 0; i < params.length; i++) {
            if (params[i] != null) {
                ...
                // of the actual column type.  Oddly, DEFAULT_NULL_REGEX and
