...
public class PessimisticLockFactory implements LockFactory {
    ...
    public static class Builder {
        ...
        public Builder acquireAttempts(int acquireAttempts) {
            CValidationUtils.isTrue(acquireAttempts > 0 || acquireAttempts == -1, "acquireAttempts needs to be a positive integer or -1, but was '" + acquireAttempts + "'");
        ...
        public Builder queueLengthThreshold(int maximumQueued) {
            CValidationUtils.isTrue(maximumQueued > 0, "queueLengthThreshold needs to be a positive integer, but was '" + maximumQueued + "'");
        ...
        public Builder lockAttemptTimeout(int lockAttemptTimeout) {
            CValidationUtils.isTrue(lockAttemptTimeout >= 0, "lockAttemptTimeout needs to be a non negative integer, but was '" + lockAttemptTimeout + "'"
            );
