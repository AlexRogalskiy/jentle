...
/**
 * Same as<br/>
 * https://docs.jboss.org/hibernate/orm/3.6/javadocs/org/hibernate/util/IdentitySet.html<br/>
 * which in turn nails down to:<br/>
 * {@link Set} implementation that use == instead of equals() as its comparison mechanism. This is achieved by internally using an HashMap.
 *
 * @param <E>
 */
public class IdentitySet<E> extends AbstractSet<E> implements Set<E>, Cloneable, Serializable {
    ...
    private transient final HashMap<Key, E> map;
    ...
    private class Key {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof IdentitySet.Key)) {
                return false;
            }

            @SuppressWarnings("unchecked") final Key theOther = (Key) obj;

            if (object == null && theOther.object != null) {
                return false;
            }
            if (object != null && theOther.object == null) {
                return false;
