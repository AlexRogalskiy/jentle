...
public class DoublyLinkedList<E>
     ...
     *                                  {@code DoublyLinkedList}
     */
    private void addListNode(ListNodeImpl<E> node) { // call this before any modification of this list is done
        if (node.list != null) {
     ...
     */
    private void moveAllListNodes(DoublyLinkedList<E> list) { // call this before any modification of this list is done
     ...
     */
    private boolean removeListNode(ListNodeImpl<E> node) { // call this before any modification of this list is done
        if (node.list == this) {
    ...
    public ListNode<E> nodeOf(Object element) {
        return searchNode(() -> head, n -> n.next, element).getLeft();
    }
    ...
    public ListNode<E> lastNodeOf(Object element) {
        return searchNode(this::tail, n -> n.prev, element).getLeft();
    }
    ...
    public ListNodeIterator<E> listIterator(E element) {
        ...
        ListNodeImpl<E> startNode = startPair.getLeft();
