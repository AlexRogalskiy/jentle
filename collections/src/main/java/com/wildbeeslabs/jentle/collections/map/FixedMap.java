...
import com.wildbeeslabs.jentle.collections.common.Containers;
import com.wildbeeslabs.jentle.collections.common.Indexer;
    ...
    public final Set<Map.Entry<K, V>> entrySet() {
        return new AbstractSet<Map.Entry<K, V>>() {
            ...
            public boolean contains(Object o) {
                ...
                return index >= 0 && values[index] == e.getValue();
            }
