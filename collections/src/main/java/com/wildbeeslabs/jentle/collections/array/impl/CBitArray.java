 ...
 * {@code byte}.</p>
 *
 * <p>Each {@code CBitArray} is constructed with a mask value, which indicates
 ...
 *    // significant bytes
 *    CBitArray blue = new CBitArray(0xFF);
 *    CBitArray green = new CBitArray(0xFF00);
 *    CBitArray red = new CBitArray(0xFF0000);
 *
 *    // anyColor is a flag triggered if any color is used
 *    CBitArray anyColor = new CBitArray(0xFFFFFF);
 *
 *    // isMetallic is a single bit flag
 *    CBitArray isMetallic = new CBitArray(0x1000000);
 * </pre>
 *
 * <p>Using these {@code CBitArray} instances, a paint instruction can be
...
public class CBitArray {
    ...
    /**
     * <p>Creates a CBitArray instance.</p>
     *
     * @param mask the mask specifying which bits apply to this
     *             CBitArray. Bits that are set in this mask are the bits
     *             that this CBitArray operates on
     */
    public CBitArray(final int mask) {
        this._mask = mask;
        this._shift_count = mask == 0 ? 0 : Integer.numberOfTrailingZeros(mask);
    }

    /**
     * <p>Obtains the value for the specified CBitArray, appropriately
     * shifted right.</p>
     *
     * <p>Many users of a CBitArray will want to treat the specified
     * bits as an int value, and will not want to be aware that the
     * value is stored as a CBitArray (and so shifted left so many
     * bits).</p>
     *
    ...
    /**
     * <p>Obtains the value for the specified CBitArray, unshifted.</p>
     *
