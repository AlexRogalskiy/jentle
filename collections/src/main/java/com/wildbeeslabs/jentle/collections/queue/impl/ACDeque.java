...
import com.wildbeeslabs.jentle.collections.queue.iface.IDeque;
import lombok.Data;
...
public abstract class ACDeque<T> extends AbstractQueue<T> implements IDeque<T> {
     ...
     * methods of the {@link java.util.Deque} and {@link Iterator} interfaces.
     *
    ...
    public static class PortableConcurrentDirectDeque<E>
        ...
        public void removeToken(Object token) {
            if (!(token instanceof PortableConcurrentDirectDeque.Node)) {
